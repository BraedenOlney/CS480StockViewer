...
<html lang="en">
	...
	<body>
		<?php
			...
			$sql = "SELECT * FROM company WHERE company_ID = 2;";
        ...
        <div class="stockGrid">
            ...
            <div class="Dividend">
                <?php 
					if(!isset($row['dividend_yield']) || !isset($row['dividend_amount'])) {
        ...
        <iframe src="" title="Amazon News"></iframe>
